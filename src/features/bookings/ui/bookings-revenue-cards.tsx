    ...
    <div className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-2">
      {items.map((item) => (
        <MetricCard
          ...
          value={item.amount}
          icon={item.icon}
          wrapperClassName="rounded-display border border-border bg-card px-6 py-5 shadow-[0_1px_0_rgba(15,23,42,0.03)] dark:border-white/10 dark:bg-background-dark"
